...
export const COLOR_PALETTES = [
  ...
  { id: 'midnight-blue', name: 'Midnight', primary: '#3b82f6', secondary: '#0a0a0a' },
  { id: 'emerald', name: 'Emerald', primary: '#10b981', secondary: '#0a0a0a' },
  { id: 'rose', name: 'Rose', primary: '#f43f5e', secondary: '#0a0a0a' },
  { id: 'slate', name: 'Slate', primary: '#94a3b8', secondary: '#0a0a0a' },
  { id: 'deep-maroon', name: 'Maroon', primary: '#991B1B', secondary: '#0a0a0a' },
];
