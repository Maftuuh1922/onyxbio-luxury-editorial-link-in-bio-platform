          ...
          <div className="relative z-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            <div className="flex-1 max-w-sm w-full bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 p-2 flex items-center">
              ...
              <input
                ...
                className="bg-transparent border-none focus:ring-0 text-white font-space flex-1 outline-none"
              />
            </div>
            <Button className="w-full sm:w-auto bg-white text-black hover:bg-white/90 font-space font-bold px-10 py-8 rounded-2xl text-lg transition-transform hover:scale-105 active:scale-95">
              Get Started Free
            </Button>
          </div>
