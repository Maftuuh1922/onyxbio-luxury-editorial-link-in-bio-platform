    ...
    <SidebarProvider>
      <div className="flex min-h-screen w-full bg-brand-bg font-karla">
        ...
        <SidebarInset className="bg-brand-bg flex flex-col pb-20 md:pb-0">
          <header className="flex h-16 items-center justify-between border-b border-gray-200 bg-white/50 backdrop-blur-md px-6 sticky top-0 z-20">
             ...
             <div className="flex items-center gap-4">
                <Link
                  to={`/${username}`}
                  target="_blank"
                  className="flex items-center gap-2 text-xs font-bold bg-brand-lime text-brand-text px-4 py-2 rounded-xl shadow-sm hover:scale-105 transition-all"
                >
          ...
          <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-white/80 backdrop-blur-lg border-t border-gray-200 px-6 py-3 z-50 flex items-center justify-between">
